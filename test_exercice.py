...
class TestExercice(unittest.TestCase):
    def test_square_root(self):
        ...
        self.assertListEqual(output, answer, "Mauvais calcul de la racine carré")
    ...
    def test_square(self):
        ...
        self.assertListEqual(output, answer, "Mauvais calcul du carré")
    ...
    def test_average(self):
        ...
        self.assertListEqual(output, answer, "Mauvais calcul de la moyenne")
    ...
    def test_to_radians(self):
        ...
        self.assertListEqual(output, answer, "Mauvais calcul de degres -> radians")
    ...
    def test_to_celsius(self):
        ...
        for o, a in zip(output, answer):
            self.assertAlmostEqual(o, a, msg="Mauvais calcul de farenheit -> celsius")
        # self.assertListEqual(output, answer, "Mauvais calcul de farenheit -> celsius")
    ...
    def test_to_farenheit(self):
        ...
        self.assertListEqual(output, answer, "Mauvais calcul de celsius -> farenheit")
